...
Similarly, [multi-agent systems](https://en.wikipedia.org/wiki/Multi-agent_system) could coordinate specialized [agents](https://en.wikipedia.org/wiki/Intelligent_agent) which each operate upon graphs of or sets of expressions and rules.

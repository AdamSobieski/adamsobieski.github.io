...
$$ e_{3} \in x_{i+1} \leftarrow e_{1} \in x_{i} \wedge e_{2} \in x_{i} $$

$$ e_{4} \notin x_{i+1} \leftarrow e_{1} \in x_{i} \wedge e_{2} \in x_{i} $$
...
$$ e_{1} \wedge e_{2} \in x_{i+1} \leftarrow e_{1} \in x_{i} \wedge e_{2} \in x_{i} $$
